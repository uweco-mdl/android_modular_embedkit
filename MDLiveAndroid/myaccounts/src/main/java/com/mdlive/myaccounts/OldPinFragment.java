 ...
 */
public class OldPinFragment extends MDLiveBaseFragment implements TextWatcher {
    ...
    public static OldPinFragment newInstance(final boolean create) {

        final OldPinFragment oldPinFragment = new OldPinFragment();

        Bundle bundle = new Bundle();
        bundle.putBoolean("update", create);
        oldPinFragment.setArguments(bundle);
    ...
    public void oldPin()
    {
        ...
        fragmentTransaction.replace(R.id.container, MyAccountNewPinFragment.newInstance(mPassCode7.getText().toString(), getArguments().getBoolean("update")),"Old Pin").commit();
    }
}