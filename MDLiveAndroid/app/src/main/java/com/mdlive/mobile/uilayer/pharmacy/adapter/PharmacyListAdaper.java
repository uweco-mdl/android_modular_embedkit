package com.mdlive.mobile.uilayer.pharmacy.adapter;
...
/**
 * This adapter class is used for list search results for search pharmacy
 *
 * This adapter is used in MDLive Pharmacy Result Page
 *
 */
public class PharmacyListAdaper extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.pharm_custom_pharmacy_searchlist_view, null);
