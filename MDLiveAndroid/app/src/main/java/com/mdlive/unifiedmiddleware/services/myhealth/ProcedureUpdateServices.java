 ...
 */
public class ProcedureUpdateServices extends BaseServicesPlugin {
    public ProcedureUpdateServices(Context context, ProgressDialog pDialog){
    ...
    public void updateAllergyRequest(String conditionId, String postBody, NetworkSuccessListener<JSONObject> responseListener, NetworkErrorListener errorListener){
        try {
            jsonObjectPutRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_PROCEDURE_LIST + "/" + conditionId,
                                    postBody,
                                    responseListener,
                                    errorListener,
                                    MDLiveConfig.IS_SSO);
