...
public class MessageCenter extends BaseServicesPlugin {
    ...
    public void getProvider(NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener) {
        try {
            jsonObjectGetRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_PROVIDER, null, successListener, errorListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void postMessage(NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener, String params) {
        try {
            jsonObjectPostRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_COMPOSE_MESSAGE, params, successListener, errorListener);
            Log.d("Test", params);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void getMyRecords(NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener) {
        try {
            jsonObjectGetRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_MY_RECORDS, null, successListener, errorListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void uploadDocument(NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener, String params) {
        try {
            jsonObjectPostRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_UPLOAD_DOCUMENT, params, successListener, errorListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void getMessaseReceivedRead(String id, NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener, String params) {
        try {
            jsonObjectGetRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_MESSAGES_READ + id + AppSpecificConfig.URL_MESSAGES_READ_TYPE + "received", params, successListener, errorListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void getMessaseSentRead(String id, NetworkSuccessListener<JSONObject> successListener, NetworkErrorListener errorListener, String params) {
        try {
            jsonObjectGetRequest(AppSpecificConfig.BASE_URL + AppSpecificConfig.URL_MESSAGES_READ + id + AppSpecificConfig.URL_MESSAGES_READ_TYPE + "sent", params, successListener, errorListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
