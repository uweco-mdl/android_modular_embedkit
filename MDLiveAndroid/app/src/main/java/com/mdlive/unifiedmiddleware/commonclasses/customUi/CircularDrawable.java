...
/**
 * Created by dhiman_da on 7/12/2015.
 */
public class CircularDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        final float min =  Math.min(mRectF.centerX(), mRectF.centerY());
        final float max =  Math.max(mRectF.centerX(), mRectF.centerY());
        canvas.drawCircle(mRectF.centerX(), mRectF.centerY(), min, mPaint);
    }
