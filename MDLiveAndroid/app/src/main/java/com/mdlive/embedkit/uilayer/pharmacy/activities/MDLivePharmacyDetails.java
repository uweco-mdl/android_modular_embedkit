...
//        });
    ...
    public void setPharmacyAsADefault(){
        ...
        pDialog = MdliveUtils.getProgressDialog("Please Wait...", MDLivePharmacyDetails.this);
        ...
        NetworkErrorListener errorListener = new NetworkErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                /*pDialog.dismiss();*/
                try {
                    MdliveUtils.handelVolleyErrorResponse(MDLivePharmacyDetails.this, error, null);
                }
                catch (Exception e) {
                    MdliveUtils.connectionTimeoutError(pDialog, MDLivePharmacyDetails.this);
                }
            }};
