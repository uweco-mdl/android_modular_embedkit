...
public class MDLiveInsuranceActivity  extends MDLiveBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        paymentIntent = new Intent(getApplicationContext(), MDLivePayment.class);
        confirmAppmtIntent = new Intent(getApplicationContext(), MDLiveConfirmappointment.class);
        if(getIntent() != null){
    ...
    private void moveToNextPage() {
        ...
        Intent i = new Intent(MDLiveInsuranceActivity.this, MDLiveConfirmappointment.class);
